...
#include "usb_identity.h" // usbserial_get_identity
...
// Fill in a USB serial string descriptor from a string
void usb_fill_string(struct usb_string_descriptor *desc, int strlen, typeof(u"") src)
{
    desc->bLength = sizeof(*desc) + strlen * sizeof(u"");
